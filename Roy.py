...
──────────────────────────────────────────────────────      
  ...
  {H}  ║{P}[{H}•{P}] Facebook  : {H}Durjoy Roy 35              {N}{H}║

    {H}║{P}[{H}•{P}] Whatsapp  : {M}+8801736259155          {N}{H}║

  {H}  ║{P}[{H}•{P}] Github    : {K}github.com/durjoy-roy1971{N}    {H}  ║
...
def mainx():
    ...
    print(f'{K} [{H}8{K}] {N}Contract MR-roy')

    print(f"{K} [{M}0{K}] {WHITE}Exit Tools ");print(led)

    mahin = input(f'{wt}Select menu {M}:{R} ')
    ...
    if mahin in ["1","01"]:
     ...
     os.system("xdg-open https://github.com/roy-ROY");mainx()

    elif mahin in ["8","08"]:

     os.system("xdg-open https://www.facebook.com/profile.php?id=100087308264850");mainx()

    elif mahin in ["0","00"]:

     print(f'{gen}{RED}Exited {H}roy-ROY {P}Terminal ');os.system("xdg-open https://www.facebook.com/profile.php?id=100087308264850");time.sleep(3);os.system('xdg-open https://www.facebook.com/profile.php?id=100087308264850');exit()

    else:

     print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/profile.php?id=100087308264850");mainx()
...
def mainx2():
    ...
    roy = input(f'{wt}Select menu {M}:{H} ')
